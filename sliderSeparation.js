...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateSlider = (clientX) => {
    ...
    currentValueSeparation = Math.round((offsetX / 300) * (max - min));
    //sliderValueDisplay.textContent = currentValue;
    sliderValueDisplay.textContent = currentValueSeparation;
    ...
    const diameter = 50 + currentValueSeparation; // Base size + slider value
