...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateSlider = (clientX) => {
    ...
    currentValueCohesion = Math.round((offsetX / 300) * (max - min));
    //sliderValueDisplay.textContent = currentValue;
    sliderValueDisplay.textContent = currentValueCohesion;
    ...
    const diameter = 50 + currentValueCohesion; // Base size + slider value
